...
const List = ({ auth, status, mustVerifyEmail }) => {
    ...
    useEffect(() => {
        ...
        const filtered = allStudent.filter(
            (student) =>
                ...
                student.academic_session.toLowerCase().includes(searchTerm)
        );
    ...
    return (
        <AuthenticatedLayout user={auth.user} mustVerifyEmail={mustVerifyEmail}>
                ...
                <section className="container mx-auto my-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {filteredStudents.length === 0 && search && (
                            <div>
                                No students found for your search. <br />{" "}
